                ...
                <div class="justify-content-start">
                    ...
                    <div class="row justify-content-start">
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="vac_publicacion" value="<?php $date = explode(" ", $vac['vac_publicacion']);
                         echo $date[0];   ?>" class="oferta estiloinput form-control" type="date">
                   ...
                   <br> </div>
                        ...
                        <input id="vac_ubicacion" style="text-transform:uppercase;" name="vac_ubicacion" placeholder="Ciudad" value="<?php echo $vac['vac_ubicacion'] ?>" class="estiloinput form-control oferta" type="text">
                         </div>
